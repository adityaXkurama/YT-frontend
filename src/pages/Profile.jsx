...
const Profile = ({sideNavbar}) => {
  return (
    <div className='profile-mainpage relative top-12 text-white flex flex-col bg-black w-full overflow-x-hidden'>
      <SideNavbar sideNavbar={sideNavbar}/>
      <div className={`${sideNavbar? "profile-section w-[calc(100%-275px)] ml-[275px] min-h-[100vh] h-auto bg-black flex flex-col  pt-5":"profile-section w-[100%]  min-h-[100vh] bg-black flex  flex-col"}`}>
       ...
       <div className="video-section  mt-5 w-full">
        <h1 className="text-2xl mb-2">
            Videos &nbsp; <ArrowRightIcon className='text-[#aaaaaa]'/>
        </h1>
        <div className="w-full h-0 border"></div>
        <div className=" grid grid-cols-4 gap-1 gap-y-4  h-[250px] ">
        <Link to={`/watch/12`} className="h-full ">
